...
def select_character_names_and_number_of_books_they_are_in
  "SELECT name, COUNT(characters.series_id) FROM characters JOIN series ON characters.series_id = series.id JOIN books on series.id = books.series_id GROUP BY books.series_id"
end
