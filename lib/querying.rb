...
def select_character_names_and_number_of_books_they_are_in
  "SELECT name, COUNT(book_id) FROM characters JOIN character_books ON characters.id = character_id GROUP BY character_id ORDER BY COUNT(book_id) DESC, name DESC"
end
