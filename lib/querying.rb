...
def select_character_names_and_number_of_books_they_are_in
  "SELECT name, COUNT(*) FROM characters JOIN series ON characters.series_id = series.id JOIN books ON series.id = books.series_id WHERE characters.series_id = books.series_id;"
end
